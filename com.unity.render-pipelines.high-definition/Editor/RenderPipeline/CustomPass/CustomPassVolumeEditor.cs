...
namespace UnityEditor.Rendering.HighDefinition
{
    ...
    sealed class CustomPassVolumeEditor : Editor
    {
        ...
        static class Styles
        {
            ...
            public static readonly GUIContent priority = new GUIContent("Priority", "Determine the execution order when multiple Custom Pass Volume overlaps with the same injection point.");
